    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-header text-white">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6 xl:gap-8 text-xs font-bold uppercase tracking-widest">
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="hover:text-brand-orange transition-colors border-b-2 border-transparent hover:border-brand-orange pb-1">Contato</a>
        </nav>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" onClick={() => setIsMenuOpen(false)} className="text-lg font-medium hover:text-brand-orange transition-all duration-300 hover:translate-x-2">Contato</a>
        </motion.div>
      )}
    </header>
  );
    ...
    content: (
      <div className="space-y-8 text-brand-graphite leading-relaxed">
        ...
        <div className="mt-16 p-10 bg-brand-graphite text-white rounded-3xl text-center">
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary inline-block">Solicite seu orçamento agora</a>
        </div>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-8 text-brand-graphite leading-relaxed">
        ...
        <div className="mt-16 p-10 bg-brand-graphite text-white rounded-3xl text-center">
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary inline-block">Solicite seu orçamento</a>
        </div>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-8 text-brand-graphite leading-relaxed">
        ...
        <div className="mt-16 p-10 bg-brand-graphite text-white rounded-3xl text-center">
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary inline-block">Solicite orçamento em Erechim</a>
        </div>
      </div>
    )
  },
    ...
    content: (
      <div className="space-y-8 text-brand-graphite leading-relaxed">
        ...
        <div className="mt-16 p-10 bg-brand-graphite text-white rounded-3xl text-center">
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary inline-block">Solicitar Orçamento</a>
        </div>
      </div>
    )
  },
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary">Solicitar orçamento</a>
...
const InstagramFeed = () => {
  const posts = [
    "/instagram-office.webp",
    "/instagram-dining.webp",
    "/instagram-commercial.webp",
    "/instagram-study.webp"
  ];
    ...
    <section id="diferenciais" className="section-padding bg-white text-brand-graphite">
      ...
      <div className="mt-20 text-center">
        ...
        >
          ...
          <a href="https://wa.me/5554991291784?text=Ol%C3%A1%2C%20vim%20pelo%20site%20e%20gostaria%20de%20um%20or%C3%A7amento" target="_blank" rel="noreferrer" className="btn-primary inline-flex items-center gap-3">
...
const FAQ = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      a: "É simples! Você pode clicar em qualquer botão de 'Solicitar Orçamento' no site ou nos chamar diretamente no WhatsApp. Agendamos uma visita técnica ou reunião em nossa fábrica."
    },
    {
  ...
  return (
    <footer className="bg-black text-white pt-24 pb-12 px-6 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-brand-gray tracking-[0.2em] uppercase font-bold">
        ...
        <p>FEITO POR: TOVEL TECNOLOGIA®</p>
  ...
  return (
    <div className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 z-50 flex flex-col items-end gap-3 sm:gap-4">
      ...
      <motion.a 
        ...
        target="_blank" 
        rel="noreferrer" 
        className="relative bg-[#25D366] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full flex items-center gap-2 sm:gap-3 shadow-2xl font-bold text-xs sm:text-sm"
      >
        <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-35 animate-ping pointer-events-none"></span>
        <MessageCircle size={18} className="sm:w-6 sm:h-6 relative z-10" fill="currentColor" />
